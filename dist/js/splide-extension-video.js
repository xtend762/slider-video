...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  (function (global, setImmediate) {
    ...
    __webpack_exports__["a"] = Player;
    /* WEBPACK VAR INJECTION */
  }).call(this, __webpack_require__(0), __webpack_require__(2).setImmediate);
  /***/
},
/* 2 */
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  __webpack_require__.r(__webpack_exports__); // CONCATENATED MODULE: ./src/js/utils/index.js
  ...
  var base_provider_BaseProvider = /*#__PURE__*/function () {
     ...
     */
    function base_provider_BaseProvider(Splide, Components) {
      this.Splide = Splide;
    ...
    var _proto = base_provider_BaseProvider.prototype;
    ...
    _proto.createPlayers = function createPlayers(Player, attributeName) {
      ...
      this.Components.Elements.getSlides(true).forEach(function (Slide) {
        if (_this6.Components.Grid) {
          each(Slide.slide.querySelectorAll("." + _this6.Components.Grid.colClass), function (slide) {
            _this6.createPlayer(slide, Player, attributeName);
          });
        }

        _this6.createPlayer(Slide.slide, Player, attributeName);
      });
    }
    /**
     * Create a player.
  ...
  var js_elements = function js_elements(Splide, slide) {
    /**
  ...
  var PLAYING = 7; // CONCATENATED MODULE: ./src/js/providers/base/base-player.js
  ...
  var base_player_BasePlayer = /*#__PURE__*/function () {
     ...
     * @param {Element} slide      - A target slide element.
     */
    function base_player_BasePlayer(Splide, Components, slide) {
      this.Splide = Splide;
      this.Components = Components;
      this.slide = slide;
      this.player = null;
    ...
    var _proto2 = base_player_BasePlayer.prototype;
    ...
    _proto2.setup = function setup() {
      ...
      this.player = this.createPlayer(function () {
        var isPendingPlay = _this7.state.is(PENDING_PLAY);
    ...
    _proto2.bind = function bind() {
      ...
      this.Splide.on('active', function (Slide) {
        if (_this8.isAutoplay()) {
          if (Slide.slide === _this8.slide) {
            _this8.play();
          } else {
            _this8.pause();
          }
    ...
    _proto2.handleClick = function handleClick() {
      ...
      this.Splide.on('drag', function () {
        _this9.shouldHandleClick = false;
      });
    }
    /**
     * Create a player.
    ...
    _proto2.createPlayer = function createPlayer(readyCallback) {
    ...
    _proto2.isAutoplay = function isAutoplay() {
      return this.Splide.options.video.autoplay;
    };

    _proto2.isHandlingClicks = function isHandlingClicks() {
    ...
    _proto2.findVideoId = function findVideoId() {
      return '';
    }
    /**
    ...
    _proto2.toggleRootClass = function toggleRootClass(add) {
    ...
    _proto2.onMouseDown = function onMouseDown() {
    ...
    _proto2.onMouseUp = function onMouseUp() {
    ...
    _proto2.onEnded = function onEnded() {
  ...
  var player_Player = /*#__PURE__*/function (_base_player_BasePlay) {
    ...
    var _proto3 = player_Player.prototype;
     ...
     */
    _proto3.createPlayer = function createPlayer(readyCallback) {
      if (readyCallback === void 0) {
        readyCallback = null;
      }
    ...
    _proto3.findVideoId = function findVideoId() {
  ...
  }(base_player_BasePlayer); // CONCATENATED MODULE: ./src/js/providers/html-video/index.js
  ...
  var html_video_HTMLVideo = /*#__PURE__*/function (_base_provider_BasePr) {
     ...
     * @param {Object} Components - An object containing components.
     */
    function html_video_HTMLVideo(Splide, Components) {
      var _this11;

      _this11 = _base_provider_BasePr.call(this, Splide, Components) || this;

      _this11.createPlayers(player_Player, 'data-splide-html-video');

      return _this11;
    }

    return html_video_HTMLVideo;
  }(base_provider_BaseProvider); // CONCATENATED MODULE: ./src/js/providers/youtube/player.js
  ...
  var youtube_player_Player = /*#__PURE__*/function (_base_player_BasePlay2) {
    ...
    var _proto4 = youtube_player_Player.prototype;
     ...
     * @return {object|null} - A created player object.
     */
    _proto4.createPlayer = function createPlayer(readyCallback) {
      var _this12 = this;
    ...
    _proto4.onPlayerReady = function onPlayerReady(e) {
      var player = e.target;
      var options = this.Splide.options.video;
    ...
    _proto4.onPlayerStateChange = function onPlayerStateChange(e) {
    ...
    _proto4.playVideo = function playVideo() {
    ...
    _proto4.pauseVideo = function pauseVideo() {
    ...
    _proto4.findVideoId = function findVideoId() {
    ...
    return youtube_player_Player;
  }(base_player_BasePlayer); // CONCATENATED MODULE: ./src/js/providers/youtube/index.js
  ...
  var youtube_YouTube = /*#__PURE__*/function (_base_provider_BasePr2) {
     ...
     * @param {Object} Components - An object containing components.
     */
    function youtube_YouTube(Splide, Components) {
      var _this13;

      _this13 = _base_provider_BasePr2.call(this, Splide, Components) || this;
      _this13.oldCallback = undefined;

      _this13.bindAPICallback();
    ...
    var _proto5 = youtube_YouTube.prototype;

    _proto5.loadAPI = function loadAPI() {
      var _window = window,
          YT = _window.YT;
    ...
    _proto5.shouldLoadAPI = function shouldLoadAPI() {
    ...
    _proto5.bindAPICallback = function bindAPICallback() {
    ...
    _proto5.onYouTubeIframeAPIReady = function onYouTubeIframeAPIReady() {
      if (this.oldCallback) {
        this.oldCallback();
      }
    ...
    _proto5.onReady = function onReady() {
      this.createPlayers(youtube_player_Player, 'data-splide-youtube');
    };

    return youtube_YouTube;
  }(base_provider_BaseProvider); // EXTERNAL MODULE: ./node_modules/@vimeo/player/dist/player.es.js


  var player_es = __webpack_require__(1); // CONCATENATED MODULE: ./src/js/providers/vimeo/player.js
  ...
  var vimeo_player_Player = /*#__PURE__*/function (_base_player_BasePlay3) {
    ...
    var _proto6 = vimeo_player_Player.prototype;
     ...
     * @return {object|null} - A created player object.
     */
    _proto6.createPlayer = function createPlayer(readyCallback) {
      if (readyCallback === void 0) {
        readyCallback = null;
      }

      var options = this.Splide.options.video;
      var player = new player_es["a"
      /* default */
    ...
    _proto6.findVideoId = function findVideoId() {
    ...
    _proto6.onPlay = function onPlay() {
    ...
    return vimeo_player_Player;
  }(base_player_BasePlayer); // CONCATENATED MODULE: ./src/js/providers/vimeo/index.js
  ...
  var vimeo_Vimeo = /*#__PURE__*/function (_base_provider_BasePr3) {
     ...
     * @param {Object} Components - An object containing components.
     */
    function vimeo_Vimeo(Splide, Components) {
      var _this14;

      _this14 = _base_provider_BasePr3.call(this, Splide, Components) || this;

      _this14.createPlayers(vimeo_player_Player, 'data-splide-vimeo');

      return _this14;
    }

    return vimeo_Vimeo;
  }(base_provider_BaseProvider); // CONCATENATED MODULE: ./src/js/providers/facebook/player.js
  ...
  var facebook_player_Player = /*#__PURE__*/function (_base_player_BasePlay4) {
    ...
    function facebook_player_Player(Splide, Components, slide) {
      ...
      _this15 = _base_player_BasePlay4.call(this, Splide, Components, slide) || this;
      _this15.fbPlayer = null;
      return _this15;
    }

    var _proto7 = facebook_player_Player.prototype;

    _proto7.destroy = function destroy() {
      _base_player_BasePlay4.prototype.destroy.call(this);
    };

    _proto7.createPlayer = function createPlayer(readyCallback) {
      if (readyCallback === void 0) {
        readyCallback = null;
      }
    ...
    _proto7.resizeFB = function resizeFB() {
    ...
    _proto7.findVideoId = function findVideoId() {
    ...
    _proto7.playVideo = function playVideo() {
      this.fbPlayer.play();
    };

    _proto7.pauseVideo = function pauseVideo() {
      this.fbPlayer.pause();
    };

    return facebook_player_Player;
  }(base_player_BasePlayer); // CONCATENATED MODULE: ./src/js/providers/facebook/index.js
  ...
  var facebook_Facebook = /*#__PURE__*/function (_base_provider_BasePr4) {
    ...
    function facebook_Facebook(Splide, Components) {
      ...
      _this16 = _base_provider_BasePr4.call(this, Splide, Components) || this;

      _this16.createPlayers(facebook_player_Player, 'data-splide-facebook');
  ...
  var splide_extension_video = function splide_extension_video(Splide, Components) {
    /**
